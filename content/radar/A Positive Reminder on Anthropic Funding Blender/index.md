+++
title = "A Positive Reminder on Anthropic Funding Blender"
date = 2026-04-29
updated = 2026-05-01
authors = ["newtbytes"]
+++
...
From blender's fund policy (emphasis added):{{ref(key="fundpolicy")}}
...
> [!note]
> Update (May 1st): The donation has changed from a Corporate Patron membership to a single donation. Additionally, "No generative AI functionality is currently available or planned to be integrated in Blender."{{ref(key="upcoming-fundpolicy")}}
